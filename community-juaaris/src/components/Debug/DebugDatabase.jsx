...
import DebugJuaaris from "./DebugJuaaris";
...
function DebugDatabase() {
  ...
  const [activeTab, setActiveTab] = useState("trivia"); // "trivia" or "match" or "juaaris"
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      <DebugTabs activeTab={activeTab} setActiveTab={setActiveTab} />
