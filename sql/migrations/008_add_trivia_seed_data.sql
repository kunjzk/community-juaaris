-- Description: Seed IPL trivia data
-- Migration: 009_seed_trivia_data.sql
-- Date: 2024-04-13
...
DELETE FROM trivia WHERE
    (match_id = 28 AND question = 'Number of wickets lost by the side bating first') OR
    (match_id = 35 AND question = 'How many runs will Gill make?') OR
    (match_id = 37 AND question = 'Number of sixes in the match') OR
    (match_id = 44 AND question = 'Number of wickets lost in the powerplay (first 6 overs) by the side batting first') OR
    (match_id = 45 AND question = 'Number of runs scored in the powerplay (first 6 overs) by the side batting first') OR
    (match_id = 52 AND question = 'Number of runs scored in the last 5 overs by the side batting first') OR
    (match_id = 53 AND question = 'Number of wickets lost in the last 5 overs (16-20) by the side batting first') OR
    (match_id = 58 AND question = 'Number of players scoring >=25 in the match') OR
    (match_id = 61 AND question = 'Highest score by an individual in the match') OR
    (match_id = 70 AND question = 'Highest number of wickets taken by an individual in the match'); 